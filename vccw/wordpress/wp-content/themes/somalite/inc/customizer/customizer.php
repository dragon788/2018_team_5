...
function somalite_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_control(
      new WP_Customize_Image_Control(
          ...
          'sm_home_image_over_bg',
          array(
              'settings'      => 'sm_home_image_over_bg',
              'section'       => 'soma_general_settings',
              'label'         => __( 'Add Image over Home Background', 'somalite' ),
              'description'   => __( 'Upload image just above the text for your home section', 'somalite' )
          )
      )
    );
   ...
   $wp_customize->add_setting(
    ...
    if(somalite_is_woocommerce_activated()){
        ...
        $wp_customize->add_control(
            'sm_shop_name',
            array(
                'settings'      => 'sm_shop_name',
                'section'       => 'soma_shop_settings',
                'type'          => 'textbox',
                'label'         => __( 'Shop Name', 'somalite' ),
                'description'   => '',
            )
        );
