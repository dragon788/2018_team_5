...
function benevolent_customizer_theme_info( $wp_customize ) {
	...
	$theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'Download Zip', 'benevolent' ) . ': </label><a href="' . esc_url( 'https://raratheme-wbtneb0y4p.netdna-ssl.com/wp-content/uploads/2017/12/benevolent-demo-content.zip' ) . '" target="_blank">' . __( 'here', 'benevolent' ) . '</a></span><br />';
